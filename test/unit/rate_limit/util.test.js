...
let RateLimitUtil = require('./../../../rate_limit/util');
...
describe('rate limit util', () => {
  ...
  test('logInfo function', function() {
    RateLimitUtil.logInfo(RateLimitResources.testRequestObject, RateLimitResources.testRateLimitPolicySourceLevel, 'test info');
